...
public class MethodOverloading01 {
    public static void main(String[] args) {
     add(3,5.8);
        //java belirsizligi sevmiyor,
        // java cagirdigimiz methodu İsim ve Parametrelerinden tanir.(method signuture)
        //java body deki{suslu parantez} degisikliklerle ilgilenmiyor
    }
    ...
    public static void add(int a, double b) { //8.8
        System.out.println(a + b);
    }
