...
public class Sb01 {
    public static void main(String[] args) {
        ...
        siz verilen capacity yi asarsaniz java yeni capacity yi varolanin 2 katinin 2 fazlasi olacak sekilde degistirir
        16==> 16*2+2 - 34==> ise 34*2+2
         */

        //Default capacity yi nasil degistiririz?
